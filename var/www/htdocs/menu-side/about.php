...
<head>
  ...
  <body>
	...
	<li>Runs very efficiently in low power mode on the batteries more than year. </li>
	<li>Designed to measure analog and digital signal. </li>
	<br /> 
	<h2>GSM box advantages :</h2> 
